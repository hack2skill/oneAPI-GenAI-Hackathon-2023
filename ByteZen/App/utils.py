...
css_path = os.path.join(
        'C:\\Users\\hemac\\Desktop\\AzureStudioChatGPTVoiceBot\\AzureStudioChatGPTVoiceBot\\assets',
        'styles.css'
    )

image_path = os.path.join(
        'C:\\Users\\hemac\\Desktop\\AzureStudioChatGPTVoiceBot\\AzureStudioChatGPTVoiceBot\\assets\\images\\settings.png'
    )
